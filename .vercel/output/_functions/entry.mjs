...
var middlewareSecret = "b24f3ddb-c106-4e0e-8691-7554948d503a";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"PUBLIC_GOOGLE_SHEETS_API_KEY": "AIzaSyCtG3uppOIps8UGNETdMa5ZCNEt7ffYUFQ",
			"PUBLIC_GOOGLE_SHEETS_ID": "1FlFw-guJpiQED_EsR_YJyUhzANy_1HU84_loZqH4_CY",
			"PUBLIC_GOOGLE_SHEETS_RANGE": "Pacientes!A:H",
			"SITE": void 0,
			"SSR": true
		}, {
			OS: "Windows_NT",
...
var _page1 = () => import("./chunks/pacientes_th6xtre4.mjs");
